...
namespace Practica2.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(TiendaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Nombre,Identificador,Descripcion,FechaRegistro,Estado")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,Nombre,Identificador,Descripcion,FechaRegistro,Estado")] Categorium categorium)
        {
